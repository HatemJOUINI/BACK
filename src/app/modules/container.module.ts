...
import { CustomEditorUserRoleComponent } from './renderers/CustomEditorUserRoleComponent';
import { CustomEditorRequirementStatus } from './renderers/custom-editor-requirement-status';
import { CustomEditorRequirementType } from './renderers/custom-editor-requirement-type';
import { CustomEditorTaskType } from './renderers/custom-editor-task-type';
import { CustomEditorTaskStatus } from './renderers/custom-editor-task-status';
import { CustomEditorCivilStatus } from './renderers/custom-editor-civilstatus';
import { CustomEditorTeamType } from './renderers/custom-editor-team-type';
import { CustomEditorContractStatus } from './renderers/custom-editor-contract-status';
import { CustomDateEditor } from './renderers/custom-date-editor';
...
@NgModule({
  ...
  declarations: [
    ...
    CustomEditorUserRoleComponent, CustomEditorRequirementStatus, CustomEditorRequirementType,
    CustomEditorTaskType, CustomEditorTaskStatus, CustomEditorCivilStatus, CustomEditorTeamType,
    CustomEditorContractStatus, CustomDateEditor, ReportAndStatisticsManagementComponent,PointingChartComponent,
    GenericTaskComponent,CreateOtherTaskComponent,DeleteErrorComponent, CustomEditorOtherTaskType
  ],
  providers: [
  ...
  entryComponents: [
    ...
    CreateTaskInListTaskComponent, CustomEditorUserRoleComponent, CustomEditorRequirementStatus, CustomEditorRequirementType,
    CustomEditorTaskType, CustomEditorTaskStatus, CustomEditorCivilStatus, CustomEditorTeamType,
    CustomEditorContractStatus, CustomDateEditor,PointingChartComponent,GenericTaskComponent,CreateOtherTaskComponent,
    DeleteErrorComponent, CustomEditorOtherTaskType
