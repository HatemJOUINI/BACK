...
export class CreateContractComponent implements OnInit {
  ...
  ngOnInit() {
    this.contractForm = this.formBuilder.group({
      ...
      coeffBase: ['',[Validators.required,Validators.min(0)]],
      coeffSunday: ['',[Validators.required,Validators.min(0)]],
      coeffSaturday: ['',[Validators.required,Validators.min(0)]],
      coeffOutOfBusinessWeek: ['',[Validators.required,Validators.min(0)]],
