...
export class UserTaskService {
  ...
  destroy(userTaskId: string): Observable<number> {
  ...
  GetAllOtherTasks(idEmployee : string): Observable<UserTask[]> {
    return this.apiService.get('api/UserTask/OtherTasks/'+idEmployee);
  }
  GetAllOtherTasksWithNotValidated(): Observable<UserTask[]> {
    return this.apiService.get('api/UserTask/OtherTasksWithNotValidated');
  }
}
